...
Όπως είναι λογικ, η μείωση της συχνότητας του ρολογιού έχει ως αποτέλεσμα την αύξηση του χρόνου εκτέλεσης. Θα περίμενε κανείς πως ο υποδιπλασιασμός της συχνότητας θα επιφέρει διπλασιασμό του χρόνου εκτέλεσης. Παρ' όλα αυτά αυτό δεν συμβαίνει στην πράξη σύμφωνα με τον παρακάτω πίνακα.
